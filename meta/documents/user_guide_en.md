...
## User Guide Novalnet
To find out how to set up the Novalnet plugin, visit the plentymarkets <a href="https://www.novalnet.com/docs/plugins/installation-guides/Installation_guide.pdf"><b>Installation Guide</b></a> with explanatory screenshots for all payment settings. The installation guide is also included in the plugin package that you download
